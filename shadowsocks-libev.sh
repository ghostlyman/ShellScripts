...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/ghostlyman/ShellScripts/master/shadowsocks_init.d_file"
}
...
pre_install(){
    ...
    read -p "(Default password: 1234@abcd):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="1234@abcd"
    echo
    echo "---------------------------"
    ...
    read -p "(Default port: 54321):" shadowsocksport
    [ -z "$shadowsocksport" ] && shadowsocksport="54321"
